      ...
      <section className="section-light">
        <div className="mx-auto max-w-[1200px] px-10 py-16 [@media(max-width:768px)]:py-12 [@media(max-width:480px)]:px-5">
          ...
          <div className="pb-7 [@media(max-width:480px)]:pt-8">
            <h1 className="mb-2 text-left font-heading text-[2.25rem] font-bold leading-tight text-neutral-900 [@media(max-width:1024px)]:text-[1.75rem] [@media(max-width:480px)]:text-2xl">
              Article Archive
            </h1>
            <p className="max-w-[560px] text-lg text-muted [@media(max-width:1024px)]:text-base">
